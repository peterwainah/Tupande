...
def ingest_csv_to_sql_server(source_directory: str, destination_directory: str, record_file: str,
                             server_name: str, database_name: str, username: str, password: str) -> None:
    """
    ...
    source_directory = r"C:\Users\Administrator\Documents\One acre\Interview\datasource\contract_offers.csv"

    # directory to move CSV files to
    destination_directory = r"C:\Users\Administrator\Documents\One acre\Interview\destination"

    # file to record ingested files
    record_file = "path/to/your/record/file.txt"
